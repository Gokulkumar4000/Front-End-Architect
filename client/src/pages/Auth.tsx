                            ...
                            {selectedRole === "idea-holder" && (
                              <>
                                    ...
                                    {["FinTech", "SaaS", "AI/ML", "HealthTech", "Web3"].map(area => (
                                      <Badge 
                                        ...
                                        className={cn(
                                          ...
                                          formData.interests?.includes(area) ? "bg-primary" : "bg-white/5 hover:bg-white/10"
                                        )}
                                        onClick={() => {
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Input className="bg-white/5 border-white/10" placeholder="e.g. Sustainable energy, education access" />
                                </div>
                                <div className="space-y-3">
                                  <Label>Have you previously worked on ideas?</Label>
                                  <RadioGroup onValueChange={(v) => updateFormData("prevIdeas", v)} value={formData.prevIdeas}>
                            ...
                            {selectedRole === "developer" && (
                              <>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Input type="number" className="bg-white/5 border-white/10" placeholder="0" />
                                </div>
                              </>
                            )}
                            ...
                            {selectedRole === "idea-holder" && (
                              <>
                                <div className="space-y-3">
                                  ...
                                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    {["Funding", "Developers", "Selling idea"].map(item => (
                                      <div key={item} className="flex items-center space-x-2 bg-white/5 p-3 rounded-lg border border-white/10">
                                        <Checkbox id={item} />
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Textarea className="bg-white/5 border-white/10 min-h-[100px]" placeholder="Describe how you like to work with others..." />
                                </div>
                              </>
                            )}
                            {selectedRole === "developer" && (
                                  ...
                                  <RadioGroup defaultValue="no">
                                    <div className="flex items-center space-x-4">
                                      <div className="flex items-center space-x-2">
                                        ...
                                        <Label htmlFor="e-yes">Yes</Label>
                                      </div>
                                      <div className="flex items-center space-x-2">
                                        <RadioGroupItem value="no" id="e-no" />
                                        <Label htmlFor="e-no">No</Label>
                                      </div>
                                    </div>
                                  </RadioGroup>
                                </div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex flex-wrap gap-2">
                                    {["Idea", "MVP", "Scaling"].map(stage => (
                                      <Badge key={stage} className="bg-white/5 hover:bg-white/10 cursor-pointer">{stage}</Badge>
                                    ))}
                                  </div>
                                </div>
                              </>
                          ...
                          <div className="space-y-6">
                            {selectedRole === "idea-holder" && (
                              <div className="space-y-2">
                                ...
                                <Input className="bg-white/5 border-white/10" placeholder="Community names..." />
                              </div>
                            )}
                            {selectedRole === "developer" && (
                              <>
                                <div className="space-y-2">
                                  ...
                                  <div className="relative">
                                    ...
                                    <Input className="pl-10 bg-white/5 border-white/10" placeholder="Company name" />
                                  </div>
                                </div>
                                <div className="space-y-2">
                                  ...
                                  <div className="relative">
                                    ...
                                    <Input className="pl-10 bg-white/5 border-white/10" placeholder="https://..." />
                                  </div>
                                </div>
                                <div className="space-y-2">
                                  ...
                                  <div className="relative">
                                    ...
                                    <Input className="pl-10 bg-white/5 border-white/10" placeholder="github.com/username" />
                                  </div>
                                </div>
                              </>
                            )}
                            {selectedRole === "investor" && (
                              <>
                                <div className="space-y-3">
                                  ...
                                  <RadioGroup onValueChange={(v) => updateFormData("isOrg", v)} value={formData.isOrg || "no"}>
                                    <div className="flex items-center space-x-4">
                                      <div className="flex items-center space-x-2">
                                ...
                                {formData.isOrg === "yes" && (
                                  <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} className="space-y-4 pt-2">
                                    <div className="space-y-2">
                                      ...
                                      <Input className="bg-white/5 border-white/10" placeholder="Org name" />
                                    </div>
                                    <div className="space-y-2">
                                      <Label>Your Role</Label>
                                      <Input className="bg-white/5 border-white/10" placeholder="Partner, Associate, etc." />
                                    </div>
                                    <div className="space-y-2">
                                      <Label>Organization Type</Label>
                                      <Input className="bg-white/5 border-white/10" placeholder="e.g. VC Firm, Angel Group" />
                                    </div>
                                  </motion.div>
                                )}
                              </>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {["Health", "Education", "Energy", "Finance", "Infrastructure"].map(d => (
                                  <Badge key={d} className="bg-white/5 hover:bg-white/10 cursor-pointer">{d}</Badge>
                                ))}
                              </div>
                            </div>
                            <div className="space-y-2">
                              ...
                              <div className="relative">
                                ...
                                <Textarea className="pl-10 bg-white/5 border-white/10 min-h-[80px]" placeholder="What is your main objective?" />
                              </div>
                            </div>
                            <div className="space-y-2">
                              ...
                              <div className="relative">
                                ...
                                <Textarea className="pl-10 bg-white/5 border-white/10 min-h-[80px]" placeholder="Describe your definition of success..." />
                              </div>
                            </div>
                          </div>
                        </>
                        ...
                        <>
                          ...
                          <div className="space-y-6">
                            <div className="space-y-2">
                              ...
                              <Textarea className="bg-white/5 border-white/10 min-h-[120px]" placeholder="A bit about your background and experience..." />
                            </div>
                            <div className="space-y-2">
                              <Label>Optional Tagline</Label>
                              <Input className="bg-white/5 border-white/10" placeholder="One sentence that defines you" />
                            </div>
                          </div>
                        </>
                      )}
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
                              <div className="flex justify-between items-center pb-4 border-b border-white/5">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <h4 className="font-bold">{formData.fullName || "John Doe"}</h4>
                                    <p className="text-xs text-muted-foreground">{formData.email || "john@example.com"}</p>
                                  </div>
                                </div>
                                <Badge className="bg-primary/20 text-primary border-primary/20 uppercase text-[10px] font-bold">
                          ...
                          {steps.slice(1).map((s, idx) => (
                            <div 
                              ...
                              className={cn(
                                ...
                                steps.indexOf(signupStep) > idx + 1 ? "w-4 bg-primary/40" : 
                                steps.indexOf(signupStep) === idx + 1 ? "w-8 bg-primary" : "w-1.5 bg-white/10"
                              )} 
                            />
                          ))}
                        </div>
                        {signupStep !== "summary" && (
                          <Button onClick={nextStep} className="font-bold px-8 group">
                            Next

  ...
  return (
    <>
      <Card className="glass-card border-white/5 hover:border-primary/20 transition-all group/card overflow-hidden">
        ...
        <CardContent className="px-4 pb-4 pt-0 space-y-3 relative overflow-hidden">
          <div className={cn(
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-2">
              <Badge 
                variant="outline" 
                className="flex items-center gap-1 text-[10px] h-5 px-2 transition-all duration-500 bg-primary/5 text-primary border-primary/20"
              >
                {typeIcon}
